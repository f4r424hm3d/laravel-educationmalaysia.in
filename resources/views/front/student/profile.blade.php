    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="profile-infos">
                    ...
                    <div class="proHead" id="myHeader">
                        <ul class="links scrollTo hor-scrlbar" data-gssticky="1">
                            <li class="active"><a href="#PerInfo">General Information <i
                                        class="fa fa-check-circle green"></i><i
                                        class="fa fa-exclamation-circle red"></i></a></li>
                            <li class=""><a href="#EduSummary">Education History <i
                                        class="fa fa-check-circle green"></i></a></li>
                            <li class=""><a href="#TestScores">Test Scores <i class="fa fa-check-circle green"></i></a>
                            </li>
                            <li class=""><a href="#BackInfo">Background Information <i
                                        class="fa fa-check-circle green"></i></a>
                            </li>
                            <li class=""><a href="#UplodDoc">Upload Documents <i
                                        class="fa fa-check-circle green"></i></a></li>
                        </ul>
                    </div>
                        ...
                        <form action="{{ $piurl }}" method="post">
                            ...
                            <div class="row">
                                    ...
                                    <div class="d-flex align-items-center set-gapsf">
                                        <div class="setcodes">
                                            ...
                                            <select name="c_code" id="c_code" class="pif select2 form-control">
                                                <option value=""
                                                    <?php echo $student->c_code == '' ? 'Selected' : ''; ?>>Select
                                                </option>
                                        ...
                                        <div class="w-100 mobiles-full">
                                            ...
                                            <input type="text" class=" pif form-control" name="mobile" id="mobile"
                                                placeholder="Enter Phone Number" value="<?php echo $student->mobile; ?>"
                                                required>
                                            @error('mobile')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
                                    ...
                                    <input type="text" class=" pif form-control" name="first_language"
                                        id="first_language" placeholder="Enter First Language"
                                        value="<?php echo $student->first_language; ?>">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
                                    ...
                                    <select name="nationality" id="nationality" class=" pif select2 form-control">
                                        ...
                                        <option value="{{ $c->name }}"
                                            {{ $student->nationality == $c->name ? 'Selected' : '' }}>
                                            {{ $c->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('nationality')
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
                                    ...
                                    <input type="text" class=" pif form-control" name="passport_number"
                                        id="passport_number" placeholder="Enter Passport Number"
                                        value="<?php echo $student->passport_number; ?>">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
                                    ...
                                    <input type="date" class=" pif form-control" name="passport_expiry"
                                        id="passport_expiry" placeholder="Enter Passport Expiry date"
                                        value="<?php echo $student->passport_expiry; ?>">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
                                    ...
                                    <select name="marital_status" id="marital_status" class=" pif select2 form-control">
                                        <option value=""
                                            <?php echo $student->marital_status == '' ? 'Selected' : ''; ?>>Select
                                        </option>
                                        @foreach ($marital_statuses as $ms)
                                        <option value="{{ $ms->marital_status }}"
                                            {{ $student->marital_status == $ms->marital_status ? 'Selected' : '' }}>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
                                    ...
                                    <select id="gender" name="gender" class=" pif select2 form-control">
                                        ...
                                        <option value="{{ $gender->gender }}"
                                            {{ $student->gender == $gender->gender ? 'Selected' : '' }}>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3   ">
                                    ...
                                    <select name="country" class=" pif form-control select2">
                                        ...
                                        @foreach ($countries as $c)
                                        <option value="{{ $c->name }}"
                                            {{ $student->country == $c->name ? 'Selected' : '' }}>
                                            {{ $c->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('country')
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3   ">
                                    ...
                                    <input type="text" class=" pif form-control" name="home_contact_number"
                                        ...
                                        value="<?php echo $student->home_contact_number; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3 ">
                                    ...
                                    <select name="country_of_education" id="country_of_education"
                                        ...
                                        <option value=""
                                            <?php echo $student->country_of_education == '' ? 'Selected' : ''; ?>>Select
                                        </option>
                                        @foreach ($countries as $row)
                                        <option value="{{ $row->name }}"
                                            {{ $student->country_of_education == $row->name ? 'Selected' : '' }}>
                                            {{ $row->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3 ">
                                    ...
                                    <select name="highest_level_of_education" id="highest_level_of_education"
                                        class=" pif form-control select2">
                                        <option value=""
                                            <?php echo $student->highest_level_of_education == '' ? 'Selected' : ''; ?>>
                                            Select
                                        </option>
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3 ">
                                    ...
                                    <select name="grading_scheme" id="grading_scheme" class=" pif form-control select2">
                                        <option value=""
                                            <?php echo $student->grading_scheme == '' ? 'Selected' : ''; ?>>Select
                                        </option>
          ...
          'Grade Points (10
              ...
              : ''; ?>>Grade Points
                                            (10 scale)</option>
                                        <option value="Grade (A to E)"
                                            <?php echo $student->grading_scheme == 'Grade (A to E)' ? 'Selected' : ''; ?>>
                                            Grade (A to E)</option>
                                    </select>
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3 ">
                                    ...
                                    <input type="text" class=" pif form-control" name="grade_average" id="grade_average"
                                        ...
                                        value="<?php echo $student->grade_average; ?>">
                                    @error('grade_average')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                    ...
                    <div class="infoContent pb-0 mb-3" id="SchAtd">
                            ...
                            <div class="col-md-12">
                                <div class="d-flex set-gap align-items-end justify-content-between">
                                    ...
                                    <button style="float:right" class="btn btn-primary"
                                        onclick="toggleSchoolAttendedForm()">Add Attended
                        ...
                        <form action="{{ $schoolurl }}" method="post" class="school-attended-form hide-this mt-3">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label
                                        style="font-size:18px!important; font-weight:400!important; color:#606a84!important;">I
                                        have
                        ...
                        <div class="row SchAtdResult" id="schitem{{ $row->id }}">
                            ...
                            <div class="col-md-12">
                                <button onclick="schItemTgl('<?php echo $row->id; ?>')"
                                    class="btn btn-primary rounded">Expand</button>
                            ...
                            <form action="{{ $editschoolurl }}" method="post" class="school-attended-form-edit">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <select name="country_of_institution" class=" pif select2">
                                            ...
                                            @foreach ($countries as $c)
                                            <option value="{{ $c->name }}"
                                                {{ $c->name == $row->country_of_institution ? 'selected' : '' }}>
                                                {{ $c->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('country_of_institution')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="" name="name_of_institution" id="name_of_institution"
                                            ...
                                            value="{{ $row->name_of_institution }}" required>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Level of Education <span class="red">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="" name="attended_institution_to"
                                            id="attended_institution_to" placeholder="Enter Attended Institution to"
                                            value="{{ $row->attended_institution_to }}" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Degree Name <span class="red">*</span></label>
                                        <input type="text" class="" name="degree_name" id="degree_name"
                                    ...
                                    <div class="col-md-4 grdf">
                                        ...
                                        <input type="date" class="" name="graduation_date" id="graduation_date"
                                            ...
                                            value="<?php echo $row->graduation_date; ?>" required>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="col-md-4 grdf">
                                        <label style="margin-top:0px!important"></label>
                                        <label class="checkRyt" style="margin-top:0px!important">
                                            ...
                                            <input class="form-check-input" type="checkbox"
                                                name="have_physical_certificate" id="have_physical_certificate"
                                                value="1"
                                                <?php echo $row->have_physical_certificate == '1' ? 'checked' : ''; ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="clearfix"></div>
                                    ...
                                    <div class="col-md-3">
                                        <label>Province</label>
                                        <input type="text" class="" name="state" id="sstate"
                                            placeholder="Enter State/Province..." value="<?php echo $row->state; ?>"
                                            required>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Postal/Zip Code</label>
                        ...
                        <form action="{{ url('student/update-test-score/') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3">
                                    ...
                                    <select name="english_exam_type" id="english_exam_type"
                                        class=" pif form-control select2" onchange="testScoreMagic()">
                                        <option value=""
                                            <?php echo $student->english_exam_type == '' ? 'Selected' : ''; ?>>Select
                                        </option>
                                        <?php
        $exmtype = ["I dont have this", "I will provide this later", "TOEFL", "IELTS", "Duolingo English Test", "PTE"];
        foreach ($exmtype as $exmtyp) {
        ?>
                                        <option value="<?php echo $exmtyp; ?>"
                                            <?php echo $student->english_exam_type == $exmtyp ? 'Selected' : ''; ?>>
                                            <?php echo $exmtyp; ?>
                                        </option>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3 ">
                                    <div class="allfh" id="date_of_exam_div">
                                        ...
                                        <input type="date" class=" pif form-control" name="date_of_exam"
                                            id="date_of_exam" placeholder="Enter Grade Average"
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3">
                                    <div class=" allfh testpartsdiv" id="listening_score_div">
                                        ...
                                        <input type="number" class=" pif form-control" name="listening_score"
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3 ">
                                    <div class="allfh testpartsdiv" id="reading_score_div">
                                        ...
                                        <input type="number" class=" pif form-control" name="reading_score"
                                            id="reading_score" placeholder="Enter Exact Score Reading"
                                            value="<?php echo $student->reading_score; ?>" step="any" min="0">
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3 ">
                                    <div class="allfh testpartsdiv" id="writing_score_div">
                                        ...
                                        <input type="number" class=" pif form-control" name="writing_score"
                                            id="writing_score" placeholder="Enter Exact Score Writing"
                                            value="<?php echo $student->writing_score; ?>" step="any" min="0">
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3">
                                    <div class=" allfh testpartsdiv" id="speaking_score_div">
                                        ...
                                        <input type="number" class=" pif form-control" name="speaking_score"
                                            id="speaking_score" placeholder="Enter Exact Score Speaking"
                                            value="<?php echo $student->speaking_score; ?>" step="any" min="0">
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3 ">
                                    <div class="allfh" id="overall_score_div">
                                        ...
                                        <input type="number" class=" pif form-control" name="overall_score"
                                            id="overall_score" placeholder="Enter Exact overall score"
                                            value="<?php echo $student->overall_score; ?>" step="any" min="0">
                                    </div>
                    ...
                    <div class="infoContent" id="AddQuali">
                        ...
                        <form class="mb-4" action="<?php echo url('student/update-gre-score'); ?>" method="post">
                            ...
                            <div class="<?php echo $student->gre == '0' || $student->gre == null ? 'hide-this' : ''; ?>"
                                id="greDiv">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3">
                                        <label>Date of Exam</label>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3">
                                        ...
                                        <div class="d-flex set-gap align-items-center justify-content-between">
                                            <input type="number" class="" name="gre_v_score" placeholder="Score"
                                                value="<?php echo $student->gre_v_score; ?>" max="170" step="any"
                                                min="0" required>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-6   col-xl-3  mb-3">
                                        ...
                                        <div class="d-flex set-gap align-items-center justify-content-between">
                                            <input type="number" class="" name="gre_q_score" placeholder="Score"
                                                value="<?php echo $student->gre_q_score; ?>" max="170" step="any"
                                                min="0" required>
                        ...
                        <form class="mb-4" action="<?php echo url('student/update-gmat-score'); ?>" method="post">
                            ...
                            <div class="<?php echo $student->gmat == '0' || $student->gmat == null ? 'hide-this' : ''; ?>"
                                id="gmatDiv">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3 ">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3 ">
                                        ...
                                        <div class="d-flex set-gap align-items-center justify-content-between">
                                            <input type="number" class="" name="gmat_v_score" placeholder="Score"
                                                value="<?php echo $student->gmat_v_score; ?>" max="51" min="0"
                                                step="any" required>
                                            <input type="number" class="" name="gmat_v_rank" placeholder="Rank"
                                                value="<?php echo $student->gmat_v_rank; ?>" step="any" max="100"
                                                min="0" required>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3 ">
                                        ...
                                        <div class="d-flex set-gap align-items-center justify-content-between">
                                            ...
                                            <input type="number" class="" name="gmat_q_score" placeholder="Score"
                                                value="<?php echo $student->gmat_q_score; ?>" max="51" min="0"
                                                step="any" required>
                                            <input type="number" class="" name="gmat_q_rank" placeholder="Rank"
                                                value="<?php echo $student->gmat_q_rank; ?>" step="any" max="100"
                                                min="0" required>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3 ">
                                        ...
                                        <div class="d-flex set-gap align-items-center justify-content-between">
                                            ...
                                            <input type="number" class="" name="gmat_w_rank" placeholder="Rank"
                                                value="<?php echo $student->gmat_w_rank; ?>" step="any" max="100"
                                                min="0" required>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3 ">
                                        ...
                                        <div class="d-flex set-gap align-items-center justify-content-between">
                                            <input type="number" class="" name="gmat_ir_score" placeholder="Score"
                                                value="<?php echo $student->gmat_ir_score; ?>" max="8" min="0"
                                                step="any">
                                            <input type="number" class="" name="gmat_ir_rank" placeholder="Rank"
                                                value="<?php echo $student->gmat_ir_rank; ?>" step="any" max="100"
                                                min="0">
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3 ">
                                        ...
                                        <div class="d-flex set-gap align-items-center justify-content-between">
                                            <input type="number" class="" name="gmat_total_score" placeholder="Score"
                                                value="<?php echo $student->gmat_total_score; ?>" min="200" max="800"
                                                step="any" required>
                                            <input type="number" class="" name="gmat_total_rank" placeholder="Rank"
                                                value="<?php echo $student->gmat_total_rank; ?>" step="any" max="100"
                                                min="0" required>
                                        </div>
                        ...
                        <form class="mb-4" action="<?php echo url('student/update-sat-score'); ?>" method="post">
                            ...
                            <div class="<?php echo $student->sat == '0' || $student->sat == null ? 'hide-this' : ''; ?>"
                                id="satDiv">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
                                        <label>Date of Exam</label>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
                                        ...
                                        <input type="number" class="" name="sat_reasoning_point"
                                            ...
                                            value="<?php echo $student->sat_reasoning_point; ?>" step="any" min="0"
                                            max="1600" required>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
                                        <label>SAT Subject Test Point</label>
                                        <input type="number" class="" name="sat_subject_point"
                                            placeholder="SAT Subject Points"
                                            value="<?php echo $student->sat_subject_point; ?>" step="any" min="0"
                                            max="800" required>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="d-flex set-gap align-items-center justify-content-end">
                    ...
                    <div class="infoContent" id="BackInfo">
                        <form action="{{ url('student/update-background-info') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class=" select2" name="refused_visa">
                                        <option value="" <?php echo $student->refused_visa == '' ? 'Selected' : ''; ?>>
                                            Select</option>
                                        <option value="Yes"
                                            <?php echo $student->refused_visa == 'Yes' ? 'Selected' : ''; ?>>Yes
                                        </option>
                                        <option value="No"
                                            <?php echo $student->refused_visa == 'No' ? 'Selected' : ''; ?>>No</option>
                                    </select>
                                    @error('refused_visa')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-md-12 mb-3">
                                    <label>Do you have a valid Study Permit / Visa? <i
                                            class="fa fa-info-circle"></i></label>
                                    <select class=" select2" name="valid_study_permit">
                                        <option value=""
                                            <?php echo $student->valid_study_permit == '' ? 'Selected' : ''; ?>>Select
                                        </option>
                                        <option value="Yes"
                                            <?php echo $student->valid_study_permit == 'Yes' ? 'Selected' : ''; ?>>Yes
                                        </option>
                                        <option value="No"
                                            <?php echo $student->valid_study_permit == 'No' ? 'Selected' : ''; ?>>No
                                        </option>
                                    </select>
                    ...
                    <div class="infoContent" id="UplodDoc">
                        <form action="{{ url('student/upload-documents') }}" method="post"
                        ...
                        <table class="table table-striped table-inverse table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->doc_name }}</td>
                                    <td>
                                        <a target="blank" href="{{ asset($row->imgpath) }}"
                                            class="btn btn-sm btn-info">View</a> | <a target="blank"
                                            href="{{ asset($row->imgpath) }}" class="btn btn-sm btn-secondary"
                                            download>Download</a>
                                    </td>
                                </tr>
                                @php
