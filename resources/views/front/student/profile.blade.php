                  ...
                  <select id="gender" name="gender" class=" pif select2">
                    ...
                    @foreach ($genders as $gender)
                      <option value="{{ $gender->gender }}"
                        {{ $student->gender == $gender->gender ? 'Selected' : '' }}>{{ $gender->gender }}</option>
                    @endforeach
                  </select>
                  @error('gender')
                    <span class="text-danger">{{ $message }}</span>
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      ...
                      <select name="country_of_institution" class=" pif select2">
                        ...
                        @foreach ($countries as $c)
                          <option value="{{ $c->name }}"
                            {{ $c->name == $row->country_of_institution ? 'selected' : '' }}>{{ $c->name }}</option>
                        @endforeach
                      </select>
                      @error('country_of_institution')
                        <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-md-3">
                      ...
                      <select name="level_of_education" id="level_of_education" class=" pif select2">
                        ...
                        @foreach ($levels as $l)
                          <option value="{{ $l->level }}" {{ $l->level == $row->level_of_education ? 'selected' : '' }}>
                            {{ $l->level }}</option>
                        @endforeach
                      </select>
                      @error('level_of_education')
                ...
                <tbody>
                  ...
                  @foreach ($stdDocs as $row)
                    <tr>
                      ...
                      <td>{{ $row->doc_name }}</td>
                      <td>
                        <a target="blank" href="{{ asset($row->imgpath) }}" class="btn btn-sm btn-info">View</a> | <a
                          target="blank" href="{{ asset($row->imgpath) }}" class="btn btn-sm btn-secondary"
                          download>Download</a>
                      </td>
                    </tr>
                    @php
