        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-xl-10 col-lg-9 col-md-9 col-12 mb-4">
                <div class="ed_detail_wrap light">
                    ...
                    <div class="head-btns">
                        <a onclick="setSource('brochure')" href="#" class="btn btn-white-t-theme btn-50L"
                            data-toggle="modal" data-target="#exampleModalCenter"><i class="ti-download mr-1"></i>
                            Download
                            Brochure</a>
                        <a onclick="setSource('fees')" href="#" class="btn btn-white-t-theme btn-50R"
                            data-toggle="modal" data-target="#exampleModalCenter"><i class="ti-user mr-1"></i> Download
                            Fees
                            Structure</a>
                                    ...
                                    <form action="{{ route('inquiry.university.profile') }}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <div
                                                        class="d-flex align-items-center setgap3 position-relative mobile-field">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <select name="intrested_subject" id="intrested_subject"
                                                        class="form-control ">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="d-flex all-regi align-items-center setgap3">
                                                        <input type="text"
                                                            placeholder="Captcha : {{ $captcha['text'] }}  ="
                                                            class="form-control  widthss"
                                                            value="Captcha : {{ $captcha['text'] }}  =" disbaled=""
                                                            readonly="">
                                            ...
                                            <div class="col-12 text-right ">
                                                <p class=" mb-3 text-left linkp">By submitting this form, you accept and
                                                    agree to our <a href="{{ route('tc') }}" rel="noopener"
