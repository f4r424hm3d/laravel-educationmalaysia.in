        ...
        <div class="ed_detail_wrap light">
          ...
          <div class="head-btns">
            ...
            <a onclick="setSource('fees')" href="#" class="btn btn-white-t-theme btn-50R" data-toggle="modal"
              data-target="#exampleModalCenter"><i class="ti-user mr-1"></i> Download Fees
              Structure</a>
              ...
              <div class="col-12 col-sm-12 col-md-8  col-lg-8 pl-md-0">
                <div class="all-white">
                  ...
                  <div class=" leadform-header">
                    <div class="lead-hdr-img"><img src="{{ asset($university->imgpath) }}" alt=""></div>
                    <div class="hdr-info">
                  ...
                  <form action="{{ route('inquiry.university.profile') }}" method="post" class="form-added"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          <div class="d-flex all-regi align-items-center setgap3">
                            <input type="text" placeholder="Captcha : {{ $captcha['text'] }}  ="
                              class="form-control  widthss" value="Captcha : {{ $captcha['text'] }}  ="
                              disbaled="" readonly="">
                      ...
                      <div class="col-12 text-right ">
                        <p class=" mb-3 text-left linkp">By submitting this form, you accept and agree to our <a
                            href="{{ route('tc') }}" rel="noopener" target="_blank">Terms of Use.</a></p>
