      ...
      <div class="row">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-4">
          <div class="footer-widget">
            ...
            <ul class="footer-menu">
              <li>
                <a href="{{ url('courses/pre-university') }}"><i class="ti-arrow-right"></i>
                  CERTIFICATE</a>
              </li>
              <li>
                <a href="{{ url('courses/pre-university') }}"><i class="ti-arrow-right"></i>PRE
                  UNIVERSITY</a>
              </li>
              <li>
                <a href="{{ url('courses/diploma') }}"><i class="ti-arrow-right"></i> DIPLOMA</a>
              </li>
              <li>
                <a href="{{ url('courses/under-graduate') }}"><i class="ti-arrow-right"></i>UNDER
                  GRADUATE</a>
              </li>
              <li>
                <a href="{{ url('courses/post-graduate') }}"><i class="ti-arrow-right"></i>POST
                  GRADUATE</a>
              </li>
              <li>
                <a href="{{ url('phd') }}"><i class="ti-arrow-right"></i>PhD COURSES</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-4">
          <div class="footer-widget">
            ...
            <ul class="footer-menu">
              ...
              <li><a href="{{ url('what-people-say') }}"><i class="ti-arrow-right"></i> What People Say</a></li>
              <li><a href="{{ url('contact-us') }}"><i class="ti-arrow-right"></i> Contact us</a></li>
              <li><a href="{{ url('terms-and-conditions') }}"><i class="ti-arrow-right"></i> Terms & Conditions</a>
              </li>
              <li><a href="{{ url('get-info') }}"><i class="ti-arrow-right"></i> Articles</a></li>
          ...
          <div class="indin-office">
            ...
            <ul>
              ...
              <li><a href="https://www.pinterest.com/educationmalaysiain/" target="_blank" rel="" class="pn"
                  aria-label="Pinterest"><i class="fa fa-pinterest-square" aria-hidden="true"></i></a> </li>
