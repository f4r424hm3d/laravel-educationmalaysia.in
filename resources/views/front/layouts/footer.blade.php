    ...
    <div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> Accounting & Finance</a></li>
                            <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> Civil Engineering</a></li>
                            <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> Arts/Fine Arts</a></li>
                            <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> Hospitality</a></li>
                            <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> Business Management</a></li>
                            <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> Computer Engineering</a></li>
                            <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> Physiology</a></li>
                            <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> Medicine</a></li>
                            <li><a href="{{ url('/') }}"><i class="ti-arrow-right"></i> Business Information
                                    Systems</a></li>
                        </ul>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            <li><a href="{{ url('/') }}/exam/ielts/overview"><i class="ti-arrow-right"></i>
                                    CERTIFICATE</a></li>
                            <li><a href="{{ url('/') }}/exam/pte/overview"><i class="ti-arrow-right"></i>PRE
                                    UNIVERSITY</a></li>
                            <li><a href="{{ url('/') }}/exam/oet/overview"><i class="ti-arrow-right"></i> DIPLOMA</a>
                            </li>
                            <li><a href="{{ url('/') }}/exam/toefl/overview"><i class="ti-arrow-right"></i>UNDER
                                    GRADUATE</a></li>
                            <li><a href="{{ url('/') }}/exam/gmat/overview"><i class="ti-arrow-right"></i>POST
                                    GRADUATE</a></li>
                            <li><a href="{{ url('/') }}/exam/nhs/overview"><i class="ti-arrow-right"></i>PhD COURSES</a>
                            </li>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            <li><a href="{{ url('/') }}/canada"><i class="ti-arrow-right"></i> FAQs</a></li>
                            <li><a href="{{ url('/') }}/usa"><i class="ti-arrow-right"></i> What People Say</a></li>
                            <li><a href="{{ url('/') }}/uk"><i class="ti-arrow-right"></i> Contact us</a></li>
                            <li><a href="{{ url('/') }}/"><i class="ti-arrow-right"></i> Terms & Conditions</a></li>
                            <li><a href="{{ url('/') }}/australia"><i class="ti-arrow-right"></i> Articles</a></li>
                            <li><a href="{{ url('/') }}/germany"><i class="ti-arrow-right"></i> Privacy Policy</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="indin-office">
                        ...
                        <ul>
                            <li><a href="https://www.facebook.com/educationmalaysia.in" target="_blank" class="fb"
                                    aria-label="Facebook"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
                            </li>
                            <li><a href="https://twitter.com/educatemalaysia/" target="_blank" class="tw"
                                    aria-label="Twitter"><i class="fa fa-twitter-square" aria-hidden="true"></i></a>
                            </li>
                            ...
                            <li><a href="https://www.pinterest.com/educationmalaysiain/" target="_blank" rel=""
                                    class="pn" aria-label="Pinterest"><i class="fa fa-pinterest-square"
                                        aria-hidden="true"></i></a> </li>
                            <li><a href="https://www.instagram.com/educationmalaysia.in/" target="_blank" rel=""
                                    class="pn" aria-label="Instagram"><i class="fa fa-instagram"
                                        aria-hidden="true"></i></a> </li>
                            <li><a href="https://www.youtube.com/@educationmalaysia6986" target="_blank" class="yt"
                                    aria-label="YouTube"><i class="fa fa-youtube-square" aria-hidden="true"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="whats-float">
            <a href="javascript:void()" class="open-button" onClick="openForm()">
                ...
                <img data-src="https://www.educationmalaysia.in/front/assets/img/wa.png" width="30" alt="whatsapp"></a>
        </div>
            ...
            <div class="wa-container">
                ...
                <div class="content">
                    ...
                    <a class="country-box" target="_blank"
                        ...
                        <div class="row align-items-center">
                            <div class="col-2 pr-0"><img
                                    data-src="https://www.educationmalaysia.in/front/assets/img/flag-india.png"
                            ...
                            <div class="col-1 pr-0 text-right"><img
                                    data-src="https://www.educationmalaysia.in/front/assets/img/wad.png"
                    ...
                    <a class="country-box" target="_blank"
                        ...
                        <div class="row align-items-center">
                            <div class="col-2 pr-0"><img
                                    data-src="https://www.educationmalaysia.in/front/assets/img/flag-malaysia.png"
                                    alt="indian flag" class="img-fluid"></div>
                            <div class="col-8 pr0">
