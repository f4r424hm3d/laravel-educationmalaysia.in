            ...
            <div class="card-body" id="tblCDiv">
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" {{ $ft == 'edit' ? 'action=' . $url : '' }}
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-12 mb-3">
                    <x-input-field type="text" label="Enter Page Slug" name="page_slug" id="page_slug"
                      :ft="$ft" :sd="$sd"></x-input-field>
                  </div>
                  <div class="col-md-9 col-sm-12 mb-3">
                    <x-input-field type="text" label="Enter Date and Address" name="date_and_address"
                      id="date_and_address" :ft="$ft" :sd="$sd"></x-input-field>
                  </div>
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-input-field type="file" label="Upload Date and Address Image" name="date_and_address_image"
