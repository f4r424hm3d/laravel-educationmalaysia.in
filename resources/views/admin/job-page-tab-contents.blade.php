          ...
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">
              {{ $page_title }} <span class="text-danger">
                ({{ $jobtab->getPage->page_name }} - {{ $jobtab->tab_name }})
              </span>
            </h4>
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/admin/job-page-tabs/' . $jobtab->getPage->id) }}">Job Page
                    Tabs</a></li>
          ...
          <div class="card">
            ...
            <div class="card-body {{ $ft == 'edit' ? '' : 'hide-thi' }}" id="tblCDiv">
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" {{ $ft == 'edit' ? 'action=' . $url : '' }}
                ...
                @csrf
                <input type="hidden" name="tab_id" id="tab_id" value="{{ $jobtab->id }}">
                <div class="row">
