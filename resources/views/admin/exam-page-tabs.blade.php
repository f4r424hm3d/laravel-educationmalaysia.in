    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          <h4 class="mb-sm-0 font-size-18">{{ $page_title }} <span class="text-danger">({{
              $exam->exam_name }})</span>
          </h4>
              ...
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" action="{{ $ft == 'edit'?$url:'#' }}"
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-InputField type="text" label="Tab Name" name="tab_name" id="tab_name" :ft="$ft" :sd="$sd">
                    </x-InputField>
                  </div>
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-InputField type="text" label="Tab URL" name="tab_slug" id="tab_slug" :ft="$ft" :sd="$sd">
                    </x-InputField>
                  </div>
                  <div class="col-md-3 col-sm-12 mb-3">
