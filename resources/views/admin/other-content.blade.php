            ...
            <form id="{{ $ft=='add' ? 'dataForm' : 'editForm' }}" {{ $ft=='edit' ?'action='.$url:'' }} class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
              ...
              <div class="row">
                <div class="col-md-9 col-sm-12 mb-3">
                  <x-InputField type="text" label="Tab Name" name="tab_name" id="tab_name" :ft="$ft" :sd="$sd"></x-InputField>
                </div>
                ...
                <div class="col-md-12 col-sm-12 mb-3">
                  <x-TextareaField label="Decription" name="description" id="description" :ft="$ft" :sd="$sd">
                  </x-TextareaField>
                </div>
              </div>
              <hr>
