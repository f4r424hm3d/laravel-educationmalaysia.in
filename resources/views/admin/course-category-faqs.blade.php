...
@section('main-section')
          ...
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/admin/course-category') }}">Course Categories</a></li>
          ...
          <div class="card">
            ...
            <div class="card-body" id="tblCDiv">
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" {{ $ft == 'edit' ? 'action=' . $url : '' }}
                ...
                @csrf
                <input type="hidden" name="course_category_id" value="{{ $course_category_id }}">
                <div class="row">
  ...
  <script>
    ...
    function getData(page) {
      ...
      var course_category_id = '{{ $course_category_id }}';
