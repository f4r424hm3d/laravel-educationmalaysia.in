              ...
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" {{ $ft == 'edit' ? 'action=' . $url : '' }}
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-StaticSelectField label="Select Page" name="page" id="page" :ft="$ft"
                      :sd="$sd" :list="$pages" savev="id" showv="name"></x-StaticSelectField>
                  </div>
                  <div class="col-md-3 col-sm-12 mb-3">
                  ...
                  <div class="col-md-12 col-sm-12 mb-3">
                    <x-TextareaField label="Review" name="review" id="review" :ft="$ft" :sd="$sd">
                    </x-TextareaField>
                  </div>
                </div>
