              ...
              <form action="{{ $url }}" class="needs-validation" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-InputField type="text" label="Enter Level" name="level" id="level" :ft="$ft"
                      :sd="$sd">
                    </x-InputField>
                  </div>
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-InputField type="text" label="Enter Level Short Name" name="short_name" id="short_name"
                      :ft="$ft" :sd="$sd"></x-InputField>
                  </div>
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-InputField type="text" label="Enter Level Seo Name" name="seo_name" id="seo_name"
                      :ft="$ft" :sd="$sd"></x-InputField>
                  </div>
                </div>
