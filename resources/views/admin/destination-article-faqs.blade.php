...
@section('main-section')
      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">{{ $page_title }} <span class="text-danger">({{ $article->title }})</span>
            </h4>
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="{{ url('/admin/') }}"><i class="mdi mdi-home-outline"></i></a></li>
                <li class="breadcrumb-item"><a href="{{ url('/admin/destinations/') }}">Destination</a></li>
                <li class="breadcrumb-item"><a href="{{ url('/admin/destination-articles/') }}">Article</a>
                </li>
            ...
            <div class="card-body {{ $ft == 'edit' ? '' : 'hide-this' }}" id="tblCDiv">
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" {{ $ft == 'edit' ? 'action=' . $url : '' }}
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 mb-3">
                    <x-TextareaField label="Answer" name="answer" id="answer" :ft="$ft" :sd="$sd">
                    </x-TextareaField>
                  </div>
                </div>
  ...
  <script>
    ...
    function getData(page) {
      ...
      var destination_article_id = '{{ $article->id }}';
