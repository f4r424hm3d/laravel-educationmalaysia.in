              ...
              <form id="{{ $ft == 'add' ? 'dataForm' : 'editForm' }}" {{ $ft == 'edit' ? 'action=' . $url : '' }}
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-12 mb-3">
                    <x-InputField type="text" label="ALt Text" name="alt_text" id="alt_text" :ft="$ft"
                      :sd="$sd"></x-InputField>
                  </div>
                  <div class="col-md-4 col-sm-12 mb-3">
                    <x-MultipleInputField type="file" label="Upload Banners" name="photo" id="photo"
                      :ft="$ft" :sd="$sd"></x-MultipleInputField>
                  </div>
                  <div class="col-md-4 col-sm-12 mb-3">
