              ...
              <form action="{{ $url }}" class="needs-validation" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 col-sm-12 mb-3">
                    <x-InputField type="text" label="Subject" name="subject" id="subject" :ft="$ft"
                      :sd="$sd">
                    </x-InputField>
                  </div>
                  <div class="col-md-2 col-sm-12 mb-3">
                    <x-InputField type="date" label="Invoice Date" name="invoice_date" id="invoice_date"
                      :ft="$ft" :sd="$sd">
                    </x-InputField>
                  </div>
                  <div class="col-md-3 col-sm-12 mb-3">
                  ...
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-InputField type="number" label="Tax" name="tax" id="tax" :ft="$ft"
                      :sd="$sd" step="any">
                    </x-InputField>
                  </div>
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-InputField type="text" label="Currency" name="currency" id="currency" :ft="$ft"
                      :sd="$sd">
                    </x-InputField>
                  </div>
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-InputField type="text" label="Invoice No" name="invoice_no" id="invoice_no" :ft="$ft"
                      :sd="$sd">
                    </x-InputField>
                  </div>
